  ...
  return (
    <section ref={ref} className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent mb-4">
            MCU TIMELINE
          </h2>
        ...
        <div className="relative max-w-7xl mx-auto">
          {/* Central Line */}
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-red-500 via-blue-500 via-purple-500 to-green-500 rounded-full"></div>
                  ...
                  <div className="bg-black/90 backdrop-blur-md p-6 rounded-2xl border border-white/10">
                    <div className="relative mb-4 overflow-hidden rounded-xl">
                      ...
                      <div className="absolute top-3 left-3 flex items-center gap-2">
                        ...
                        {event.type === 'special' && <Play className="w-4 h-4 text-white" />}
                    ...
                    <h3 className={`text-lg md:text-xl font-bold mb-2 ${event.major ? 'text-yellow-400' : 'text-white'}`}>
                      {event.title}
                    </h3>
